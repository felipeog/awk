...
@test 'long, mixed-case word' {
    run gawk -f $AWK_FILE <<< 'OxyphenButazone'
...
@test 'bonus: blank tile counts as zero' {
    run gawk -f $AWK_FILE <<< 'abcdefghijklmnop rstuvwxyz'
